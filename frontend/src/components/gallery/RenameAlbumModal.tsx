...
export const RenameAlbumModal: React.FC<RenameAlbumModalProps> = ({
  isOpen,
  folder,
  onClose,
  onRename,
      ...
      <div className="relative w-full max-w-md glass-strong rounded-3xl p-6 shadow-2xl border border-border-default/60 animate-fade-in-scale">
        <div className="flex items-center justify-between pb-4 border-b border-border-subtle">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-text-primary text-lg">Ubah Nama Album</h3>
              <p className="text-xs text-text-muted">Perbarui judul koleksi Anda</p>
            </div>
          </div>
          <button
            onClick={onClose}
